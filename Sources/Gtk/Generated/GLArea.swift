...
let handler1: @convention(c) (UnsafeMutableRawPointer, GtkGdk.GLContext, UnsafeMutableRawPointer) -> Void =
    { _, value1, data in
        SignalBox1<GtkGdk.GLContext>.run(data, value1)
    }

addSignal(name: "render", handler: gCallback(handler1)) { [weak self] (param0: GtkGdk.GLContext) in
    guard let self = self else { return }
...
addSignal(name: "notify::allowed-apis", handler: gCallback(handler3)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::api", handler: gCallback(handler4)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::auto-render", handler: gCallback(handler5)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::context", handler: gCallback(handler6)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::has-depth-buffer", handler: gCallback(handler7)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::has-stencil-buffer", handler: gCallback(handler8)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::use-es", handler: gCallback(handler9)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
public var render: ((GLArea, GtkGdk.GLContext) -> Void)?
